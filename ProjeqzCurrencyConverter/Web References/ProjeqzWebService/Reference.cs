...
namespace ProjeqzCurrencyConverter.ProjeqzWebService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="ProjeqzCurrencyConverterServiceSoap", Namespace="http://microsoft.com/webservices/")]
    public partial class ProjeqzCurrencyConverterService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ProjeqzCurrencyConverterService() {
            this.Url = global::ProjeqzCurrencyConverter.Properties.Settings.Default.ProjeqzCurrencyConverter_ProjeqzWebService_ProjeqzCurrencyConverterService;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://microsoft.com/webservices/Convert", RequestNamespace="http://microsoft.com/webservices/", ResponseNamespace="http://microsoft.com/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void ConvertAsync(string fromCurrency, string toCurrency) {
            this.ConvertAsync(fromCurrency, toCurrency, null);
        }
        
        /// <remarks/>
        public void ConvertAsync(string fromCurrency, string toCurrency, object userState) {
            ...
            this.InvokeAsync("Convert", new object[] {
                        fromCurrency,
                        toCurrency}, this.ConvertOperationCompleted, userState);
        }
